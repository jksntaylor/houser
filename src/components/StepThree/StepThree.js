...
class StepThree extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <input value={this.props.mortgage} placeholder='Mortgage' onChange={e=> this.props.updateMortgage(e.target.value)}/>
                <input value={this.props.rent} placeholder='Rent' onChange={e=> this.props.updateRent(e.target.value)}/>
